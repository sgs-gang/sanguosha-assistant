...
const pages: string[] = ["https://sanguoshaenglish.blogspot.com/2010/07/liu-bei.html",
...
async function execute(pageUrl: string) {
  ...
  const imageUrl = $('#Blog1 > div.blog-posts.hfeed > div > div > div > div.post.hentry > div.cover > div > div > a > img').attr('src')
  const description = $('#Blog1 > div.blog-posts.hfeed > div > div > div > div.post.hentry > div.cover > div > div > b:nth-child(5) > span').text()
  const name = $('#Blog1 > div.blog-posts.hfeed > div > div > div > div.post.hentry > div.bposttitle > h2 > a').text()
  const abilityElements = $('#Blog1 > div.blog-posts.hfeed > div > div > div > div.post.hentry > div.cover > div > div > div:nth-child(12) > div')
  const abilities = []
