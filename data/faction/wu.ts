...
export const wu: Character[] = [
  {
    ...
    description: 'Young and Virtuous Ruler 年轻的贤君 (nián qīng dè xián jūn)',
  },
  {
    ...
    description: 'The Flower of few words 矜持之花 (jīn chí zhī huā)',
  },
  {
    ...
    description: 'The Pirate with Silk Sails 锦帆游侠 (jǐn fān yóu xiá)',
  },
  {
  ...
  },
  {
    ...
    description: 'Crossing the river in White Robes 白衣渡江 (bái yī dù jiāng)',
  },
  {
    ...
    abilities: [
      {
        ...
        enforced: true,
        description: 'You cannot become the target of STEAL and BLAZE.',
        explanation:
  ...
  },
  {
    ...
    abilities: [
      ...
      },
      {
        ...
        explanation:
          '2 cards can be drawn for each equipped card that is removed. This applies also to changing the equipped item (ie: replacing one weapon with another weapon)',
      },
    ],
    description: 'The lady with bow and arrows 弓腰姬 (gōng yāo jī)',
  },
  {
    ...
    description: 'Supreme Commander-in-Chief 大都督 (dà dū dū)',
  },
  {
    ...
    description: 'Ardent and Loyal Warrior 笃烈之士 (dǔ liè zhī shì)',
  },
  {
    ...
    description: 'The Unconventional Flower 矫情之花 (jiǎo qíng zhī huā)',
  },
  {
    ...
    description: 'Body scarred like a Battle record 历战之躯 (lì zhàn zhī qū)',
  },
  {
    ...
    description: 'Emperor of Vigorous Combat 武烈帝 (wǔ liè dì)',
  },
  {
    ...
    description: 'The Maverick Diplomat 独断的外交家 (dú duàn dè wài jiāo jiā)',
  },
]
